export default function LockKeyHole(props) {
   return (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" width={props.w} height={props.h} className={props.className} fill={props.fill}>
